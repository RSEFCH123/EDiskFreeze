...
typedef struct _SYSTEM_PERFORMANCE_INFORMATION {
	...
	ULONG CcFastReadResourceWait;
	ULONG CcFastReadNotPossible;
	ULONG CcFastMdlReadNoWait;
	ULONG CcFastMdlReadWait;
	ULONG CcFastMdlReadResourceWait;
...
EXTERN_C NTSTATUS PspTerminateThreadByPointer(PETHREAD Thread, ULONG ntExitCode, BOOLEAN bDirectTerminate);

extern "C" POBJECT_TYPE * PsLoadedModuleType;
